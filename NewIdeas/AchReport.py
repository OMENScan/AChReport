            ...
            with open(filname, 'r', encoding='utf8', errors="replace") as csvfile:
                ...
                for csvrow in csvread:
                    if len(csvrow) > 4:
                        ...
                        ipsfileall.write(PreIOC + csvrow[5] + PostIOC + "\n")
                ...
                for csvrow in csvread:
                    if len(csvrow) > 7:
                        ...
                        if not fullURL.startswith("file:///"):
                            ...
                            if len(url_split) > 2:
                                domfileall.write(PreIOC + url_split[2] + PostIOC + "\n")
            ...
            with open(filname, 'r', encoding='utf8', errors="replace") as csvfile:
                ...
                for csvrow in csvread:
                    if len(csvrow) > 11:
                        ...
                        # Write out IP Address for Bulk Lookup 
                        ipsfileall.write(PreIOC + csvrow[8] + PostIOC + "\n")
                ...
                for csvrow in csvread:
                    if len(csvrow) > 10:
                        ...
                        if len(csvrow) > 11:
                            ...
                            hshfileall.write(PreIOC + csvrow[11] + PostIOC + "\n")
                        else:
            ...
            for innline in innfile:
                ...
                if writeRow > 0:
                    ...
                    if writeRow == 1:
                        ...
                        ipsfileall.write(PreIOC + RecType.strip() + PostIOC + "\n")

                        # Write out Domain for Bulk Lookup 
                        domfileall.write(PreIOC2 + RecName.strip() + PostIOC2 + "\n")
                    elif writeRow == 3:
                        outfile.write("<td width=25%>" + PreIOC2 + RecName.strip() + PostIOC2 + "</td>\n")
                        outfile.write("<td width=25%>" + PreIOC + RecType.strip() + PostIOC + "</td>\n")
                ...
                for csvrow in csvread:
                    if len(csvrow) > 4:
                        ...
                        if reccount == 0:
                            ...
                            # Write out Domain for Bulk Lookup 
                            domfileall.write(PreIOC2 + csvrow[0].strip() + PostIOC2  + "\n")
                        ...
                        if reccount == 0:
                            ...
                            outfile.write("<" + tdtr + " width=35%> <A href=https://www.virustotal.com/#/search/" + csvrow[4] + ">" + PreIOC + csvrow[4] + PostIOC + "</a> </" + tdtr + "></tr>\n")
                            # Write out IP Address for Bulk Lookup 
                            ipsfileall.write(PreIOC + csvrow[4].strip() + PostIOC + "\n")
