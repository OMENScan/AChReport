...
def main():
    ...
    if os.path.isfile(filname):
        ...
        with open(filname, 'rb') as csvfile:
    ...
    if os.path.isfile(filname):
        ...
        if reccount > 0:
            reccount = 0
            dedupCnt, dedupCol = zip(*sorted(zip(dedupCnt, dedupCol), reverse=True))
    ...
    outfile.write("<th width=30%> Image Path </th>\n")
            ...
            for csvrow in csvread:
                if len(csvrow) > 8:
                    if "currentversion\\run" in csvrow[1].lower():
                        ...
                        outfile.write("<td width=30%>" + csvrow[8] + "</td>\n")
                        if len(csvrow) > 11:
        ...
        with open(filname, 'rb') as csvfile:
            ...
            for csvrow in csvread:
                if len(csvrow) > 8:
                    ...
                    outfile.write("<" + tdtr + " width=30%>" + csvrow[8] + "</" + tdtr + ">\n")
                    if len(csvrow) > 11:
